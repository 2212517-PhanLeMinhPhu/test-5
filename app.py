...
import sys
import os
import altair as alt # Đã thêm thư viện vẽ biểu đồ chuẩn
...
try:
    ...
    # Đã gỡ bỏ from charts import... để dùng hàm vẽ mượt mà hơn ngay trong app
...
def get_weather_chart(df):
    ...
    plot_df = df.copy()
    plot_df['Thời gian'] = pd.to_datetime(plot_df['
